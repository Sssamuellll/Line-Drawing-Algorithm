...
set terminal GNUTERM size 1000,1000
set encoding utf8
#==============================================================================
# MULTIPLOT
#==============================================================================
set multiplot layout 2,2 rowsfirst downwards

#==============================================================================
# SETUP COMMANDS
#==============================================================================
set xrange [0.000000:60.000000]
set yrange [0.000000:60.000000]
...
#==============================================================================
plot \
    'plot0.dat' index 0 title '2D' with linespoints linestyle 1 linewidth 2
...
set xrange [0.000000:60.000000]
set yrange [0.000000:60.000000]
set zrange [0.000000:60.000000]
set xlabel 'x' enhanced textcolor '#404040'
set ylabel 'y' enhanced textcolor '#404040'
set zlabel 'z' enhanced textcolor '#404040'
...
#==============================================================================
splot \
    'plot1.dat' index 0 title 'Before Rotation' with points linestyle 1 linewidth 2
#==============================================================================
# SETUP COMMANDS
#==============================================================================
set xrange [-60.000000:60.000000]
set yrange [-60.000000:60.000000]
set zrange [-60.000000:60.000000]
set xlabel 'x' enhanced textcolor '#404040'
set ylabel 'y' enhanced textcolor '#404040'
set zlabel 'z' enhanced textcolor '#404040'
...
#==============================================================================
splot \
    'plot2.dat' index 0 title 'After Rotation' with points linestyle 1 linewidth 2
unset multiplot
